      ...
      <div className="flex flex-col gap-5 w-full sm:w-md p-5 sm:p-10 bg-white border-2 border-blue-400 rounded-lg">
        ...
        <div>
          <div className="flex flex-col gap-1">
            ...
            }} value={email} className="border-2 border-blue-300 rounded py-1 px-2" id="email" type="text" />
          </div>
          <div className="flex flex-col gap-1">
            <label htmlFor="password">Password</label>
            <input required onChange={(event) =>{setPassword(event.target.value)}} value={password} className="border-2 border-blue-300 rounded py-1 px-2" id="password" type="text" />
          </div>
        </div>
